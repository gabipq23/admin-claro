        ...
        <div className="flex  justify-between items-center p-2 bg-[#d4d4d4] px-6 md:px-10 lg:px-14">
          <div className="flex items-center gap-8">
            <Dropdown menu={{ items: ordersMenuItems }} placement="bottom">
              <a
                ...
                className={`text-[14px] cursor-pointer text-[#da291c] hover:text-[#b41e13] ${selectedLink === "pedidos-banda-larga-pf" || selectedLink === "pedidos-banda-larga-pj" || selectedLink === "pedidos-telefonia-movel-pj" || selectedLink === "pedidos-telefonia-movel-pf"
                  ? "font-bold text-[#b41e13]"
                  : ""
                  }`}
              >
                Pedidos
            ...
            <Dropdown menu={{ items: productsMenuItems }} placement="bottom">
              <a
                onClick={(e) => e.preventDefault()}
                className={`text-[14px] cursor-pointer text-[#da291c] hover:text-[#b41e13] ${selectedLink === "produto-banda-larga"
                  ? "font-bold text-[#b41e13]"
                  : ""
                  }`}
              >
            ...
            <Dropdown menu={{ items: clientsMenuItems }} placement="bottom">
              <a
                onClick={(e) => e.preventDefault()}
                className={`text-[14px] cursor-pointer text-[#da291c] hover:text-[#b41e13] ${selectedLink === "clientes-pj" || selectedLink === "clientes-pf"
                  ? "font-bold text-[#b41e13]"
                  : ""
                  }`}
              >
            ...
            <a
              ...
              className={`text-[14px] cursor-pointer text-[#da291c] hover:text-[#b41e13] ${selectedLink === "contatos" ? "font-bold text-[#b41e13]" : ""
                }`}
            >
              Mensagens
            </a>
            ...
            <Dropdown menu={{ items: chatsMenuItems }} placement="bottom">
              <a className="text-[14px] cursor-pointer text-[#da291c] hover:text-[#b41e13]">
                Chatter
              </a>
            </Dropdown>
            ...
            <a
              ...
              className={`text-[14px] cursor-pointer text-[#da291c] hover:text-[#b41e13] ${selectedLink === "book-de-ofertas"
                ? "font-bold text-[#b41e13]"
                : ""
                }`}
            >
            ...
            <Dropdown menu={{ items: toolsMenuItems }} placement="bottom">
              <a
                onClick={(e) => e.preventDefault()}
                className={`text-[14px] cursor-pointer text-[#da291c] hover:text-[#b41e13] ${selectedLink === "pj-checker" ||
          ...
          <div className="flex items-center gap-4">
            ...
            <Button
              ...
              className="logout-btn "
            >
              <LogoutOutlined style={{ color: "#da291c" }} />
            </Button>
            <style>
              {`
